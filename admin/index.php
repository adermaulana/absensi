                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-7">
                        ...
                        <p class="text-muted">Show overview jan 2018 - Dec 2019 <a class="text-muted font-weight-medium ps-2" href="#"><u>See Details</u></a></p>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-sm-8">
                        <p class="text-muted mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore. <b>Learn More</b></p>
                      </div>
                      <div class="col-sm-4">
              ...
              <div class="col-xl-8 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body px-0 overflow-auto">
                    ...
                    <a class="text-black mt-3 d-block ps-4" href="#"> <span class="font-weight-medium h6">View all order history</span> <i class="mdi mdi-chevron-right"></i></a>
                  </div>
                </div>
              </div>
                    ...
                    <h4 class="card-title">
                      <span class="d-flex justify-content-between">
                        ...
                        <span class="dropdown dropleft d-block">
                          <span id="dropdownMenuButton1" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="col-5 col-sm-4">
                          <div class="d-flex pt-1 align-items-center">
                            ...
                            <div class="dropdown dropleft ps-1 pt-3">
                              <div id="dropdownMenuButton2" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                      ...
                      <div class="row align-items-center">
                        ...
                        <div class="col-5 col-sm-4">
                          <div class="d-flex pt-1 align-items-center">
                            ...
                            <div class="dropdown dropleft ps-1 pt-3">
                              <div id="dropdownMenuButton3" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                <p><i class="mdi mdi-dots-vertical"></i></p>
                              </div>
                      ...
                      <div class="row align-items-center">
                        ...
                        <div class="col-5 col-sm-4">
                          <div class="d-flex pt-1 align-items-center">
                            ...
                            <div class="dropdown dropleft ps-1 pt-3">
                              <div id="dropdownMenuButton4" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                <p><i class="mdi mdi-dots-vertical"></i></p>
                              </div>
                      ...
                      <div class="row align-items-center">
                        ...
                        <div class="col-5 col-sm-4">
                          <div class="d-flex pt-1 align-items-center">
                            ...
                            <div class="dropdown dropleft ps-1 pt-3">
                              <div id="dropdownMenuButton5" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                <p><i class="mdi mdi-dots-vertical"></i></p>
                              </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="me-2" src="assets/images/browser-logo/opera-logo.png" alt=""> <span class="p">opera mini</span>
                          </div>
                          <p class="mb-0">23%</p>
                        </div>
                      </div>
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="me-2" src="assets/images/browser-logo/safari-logo.png" alt=""> <span class="p">Safari</span>
                          </div>
                          <p class="mb-0">07%</p>
                        </div>
                      </div>
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="me-2" src="assets/images/browser-logo/chrome-logo.png" alt=""> <span class="p">Chrome</span>
                          </div>
                          <p class="mb-0">33%</p>
                        </div>
                      </div>
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="me-2" src="assets/images/browser-logo/firefox-logo.png" alt=""> <span class="p">Firefox</span>
                          </div>
                          <p class="mb-0">17%</p>
                        </div>
                      </div>
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between">
                          <div>
                            <img class="me-2" src="assets/images/browser-logo/explorer-logo.png" alt=""> <span class="p">Explorer</span>
                          </div>
                          <p class="mb-0">05%</p>
                        </div>
                      </div>
