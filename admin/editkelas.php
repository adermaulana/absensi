...
if (isset($_POST['update'])) {
    ...
    $query =
        "UPDATE kelas SET 
      nama_kelas = '" .
        mysqli_real_escape_string($koneksi, $_POST['nama_kelas']) .
        "',
      wali_kelas_id = '" .
        mysqli_real_escape_string($koneksi, $_POST['wali_kelas_id']) .
        "',
      tahun_ajaran = '" .
        mysqli_real_escape_string($koneksi, $_POST['tahun_ajaran']) .
        "'
      WHERE id = '$kelas_id'";
                                    ...
                                    <form class="forms-sample" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tahun_ajaran"
                                                placeholder="Contoh: 2023/2024" name="tahun_ajaran"
